...
summary: "A computer vision system using the TensorFlow API with neural network tuning, and built a responsive user interface in Javascript React.js, including a 'dog barking' feature."
images:
  - "/images/projects/project-01/signs_data_kiank1.jpg"
  - "/images/projects/project-01/handdetector1.png"
  - "/images/projects/project-01/handdetector2.png"
team:
  - name: "John Doe"
    role: "Software Engineer"
    avatar: "/images/avatar.jpg"
    linkedIn: "https://www.linkedin.com/in/dunyan"
link: "https://hand-detector.vercel.app/"
---
...
This project demonstrates your ability to leverage automation and streamline projectflows, which is highly relevant for Electrical Software Engineering portfolios focused on efficiency and innovation.