      ...
      <Flex fillWidth mobileDirection="column" horizontal="center">
        ...
        <Column className={styles.blockAlign} flex={9} maxWidth={40}>
          ...
          {about.project.display && (
            <>
              <Heading as="h2" id={about.project.title} variant="display-strong-s" marginBottom="m">
                {about.project.title}
              </Heading>
                  ...
                  <Column key={`${experience.company}-${experience.role}-${index}`} fillWidth>
                    ...
                    {experience.images.length > 0 && (
                      <Flex fillWidth paddingTop="s" paddingLeft="40" wrap>
                        {(experience.images as { width: number; height: number; src: string; alt: string }[]).map((image, index) => (
                          <Flex
                            key={index}
